        ...
        <div className="col-md-10">
            ...
            <div className="row p-2 bg-white border rounded mt-2 d-flex justify-content-between">
                ...
                <div className="col-md-6 mt-1">
                    ...
                    <p className="text-justify para mb-0">Quantity : {props.quantity}</p>
                ...
                <div className="align-items-center align-content-center col-md-3 border-left mt-1 ml-3">
                    ...
                    <div className="d-flex flex-column mt-4">
                        {/* <button className="btn btn-primary btn-sm" type="button" onClick={()=>{ phno ? setphno(false): setphno(true) }}>SELL</button> */}
                        <div className='d-flex align-items-center'>
                        <i className="fas fa-edit mx-3 " onClick={()=>{props.handleclick(props.note)}}></i>
